...
def solitario():
    ...
    for i in range(intentos):
        ...
        if var2 == var1:
            ...
            retornar={"Ganador":True,"Dificultad":opc4,"Nombre":nombre}
        ...
        if i==(intentos-1):
            ...
            nombre=input("Introduzca su nombre: ").upper()
            retornar={"Ganador":False,"Dificultad":opc4,"Nombre":nombre}
...
def comenzar():
    ...
    while True:
            ...
            if a == 1:
                resultado=solitario()
                estadistica.append([resultado["Nombre"],a,resultado["Dificultad"],resultado["Ganador"]])
            elif a == 2:
                resultado2=multijugador()
                estadistica.append([resultado2["Nombre"],a,resultado2["Dificultad"],resultado2["Ganador"]])
...
#df= pd.read_csv(r'datasets/hum:temp.csv',encoding='ISO-8859-1',delimiter=';') # Leer Excel
